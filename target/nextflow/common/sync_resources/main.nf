...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/common-resources/common-resources/src/sync_resources/"
      }
    ],
    "description" : "Synchronise resources from s3 to a directory",
    "usage" : "sync_resources\nsync_resources --input s3://openproblems-data/resources_test --output resources_test\n",
    "test_resources" : [
      {
        "type" : "bash_script",
        "path" : "run_test.sh",
  ...
  "info" : {
    "config" : "/home/runner/work/common-resources/common-resources/src/sync_resources/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/home/runner/work/common-resources/common-resources/target/nextflow/common/sync_resources",
    "viash_version" : "0.8.6",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common/sync_resources",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
